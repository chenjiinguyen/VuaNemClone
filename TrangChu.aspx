                ...
                <ul class="cap1" style="background-color: white; width: 74%; height: 170px; margin-left: 176px; margin-top: -10px">
                    <li class="hover-li"><a href="#" style="padding-right: 40px; border-bottom: 2px solid #20315C; letter-spacing: 1px">LOẠI NỆM</a>
                        <div class="list-item" style="margin-left: -200px; margin-top: 10px">
                            <a href="#">
                                <img style="width: 150px; height: 100px; padding-right: 10px" src="styles/images/menu_loainem/nembongep.png" alt="Alternate Text" /></a>
                            <a href="#">
                                <img style="width: 150px; height: 100px; padding-right: 10px" src="styles/images/menu_loainem/nemcaosu.png" alt="Alternate Text" /></a>
                            <a href="#">
                                <img style="width: 150px; height: 100px; padding-right: 10px" src="styles/images/menu_loainem/nemfoam.png" alt="Alternate Text" /></a>
                            <a href="#">
                                <img style="width: 150px; height: 100px" src="styles/images/menu_loainem/nemloxo.png" alt="Alternate Text" /></a>
                        </div>
                    </li>
                    <li class="hover-li"><a href="#" style="border-bottom: 2px solid #20315C; letter-spacing: 1px;">THƯƠNG HIỆU</a>
                        <div class="list-item size-img" style="margin-top: 20px; margin-left: -200px">
                            <a href="#">
                                <img style="padding-right: 20px" src="styles/images/menu_thuonghieu/aeroflow.png" alt="Alternate Text" /></a>
                            <a href="#">
                                <img style="padding-right: 20px" src="styles/images/menu_thuonghieu/dunlopillo.png" alt="Alternate Text" /></a>
                            <a href="#">
                                <img style="padding-right: 20px" src="styles/images/menu_thuonghieu/good-night.png" alt="Alternate Text" /></a>
                            <a href="#">
                                <img src="styles/images/menu_thuonghieu/therapedic.png" alt="Alternate Text" /></a>
                        </div>
                    </li>
                </ul>
            </div>
